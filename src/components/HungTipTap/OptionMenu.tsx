...
import { GROQ_API_KEY } from "../../setting";

export const GrammarCheck = ({ onClose, editor }) => {
...
export const TranslateOption = ({ onClose, editor }) => {
  const [loading, setLoading] = useState(false);
  ...
  return (
    <div className="min-w-[300px]">
      ...
      <div className="p-2 space-y-2">
        ...
        {!apiKey || apiKey === "your-groq-api-key" ? (
        ...
        {loading ? (
          ...
          <button
            onClick={translate}
            disabled={!apiKey || apiKey === "your-groq-api-key"}
...
export const LintOption = ({ onClose, editor }) => {
